    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblBookRecord", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tblBookRecord_tblBook_BookId",
                        column: x => x.BookId,
                        principalTable: "tblBook",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tblBookRecord_tblStudent_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BookId = table.Column<int>(nullable: false),
                    Fufilled = table.Column<bool>(nullable: false),
                    RequestDate = table.Column<DateTime>(nullable: false),
                    StudentId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblBookRequest", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tblBookRequest_tblBook_BookId",
                        column: x => x.BookId,
                        principalTable: "tblBook",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblBookRecord_BookId",
                table: "tblBookRecord",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_tblBookRecord_StudentId",
                table: "tblBookRecord",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_tblBookRequest_BookId",
